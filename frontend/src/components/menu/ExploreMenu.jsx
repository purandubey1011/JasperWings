...
const ExploreMenu = () => {
  ...
  const MENU_ITEMS = {
    ...
    tenders: [
      { id: 8, title: "1 Tender", price: "$6.99", image: "/menu/menufood.png" },
      {
        id: 9,
        title: "3 Tenders",
        price: "$18.99",
    ...
    fries: [
      ...
      { id: 30, title: "Poutine", price: "$8.99", image: "/menu/menufood.png" },
    ],
    ...
    drinks: [
      ...
      { id: 46, title: "Juice", price: "$3.49", image: "/menu/menufood.png" },
    ],
  };
